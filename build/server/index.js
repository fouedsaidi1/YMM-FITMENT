...
function Compatibility() {
  ...
  const handlePickProduct = async () => {
    const selected = await shopify2.resourcePicker({ type: "product", multiple: false });
  ...
  return /* @__PURE__ */ jsxs(
    Page,
    {
      ...
      primaryAction: filters.model ? { content: "Add Compatibility Rule", onAction: openModal } : void 0,
      children: [
            ...
            /* @__PURE__ */ jsxs(InlineGrid, { columns: 3, gap: "300", children: [
              ...
              /* @__PURE__ */ jsx(
                Select,
                {
                  ...
                  value: filters.model ? String(((_a2 = models.find((m) => m.name === filters.model)) == null ? void 0 : _a2.id) || "") : "",
                  onChange: (v) => {
                    var _a3;
        ...
        /* @__PURE__ */ jsx(
          Modal,
          {
            ...
            children: /* @__PURE__ */ jsx(Modal.Section, { children: /* @__PURE__ */ jsxs(BlockStack, { gap: "400", children: [
              /* @__PURE__ */ jsx(InlineStack, { gap: "300", align: "start", children: /* @__PURE__ */ jsx(Button, { onClick: handlePickProduct, children: productId ? "Change Product" : "Select Product from Store" }) }),
              productTitle && /* @__PURE__ */ jsx(Banner, { tone: "success", children: /* @__PURE__ */ jsxs("p", { children: [
                "Selected: ",
                /* @__PURE__ */ jsx("strong", { children: productTitle })
              ] }) }),
              /* @__PURE__ */ jsx(
                TextField,
                {
